...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            {
                // Garis lintasan akan digambar dari titik tengah bola saat ini ke titik tengah bola pada saat tumbukan, yaitu sebuah titik yang di-offset 
                // dari titik tumbukan berdasar vektor normal titik tersebut sebesar jari-jari bola.
